...
# Custom Params (refer to img_labelinclude/openpose/flags.hpp for more parameters)
params = dict()
...
for i, image in enumerate(imagePaths):
    ...
    if name_check not in all_poses:
        ...
        save_pose(datum, index_sorted, index_speaker, file_npy, save_speaker_path, save_other_path, img_label)
